...
import 'package:messenger_clone/view/home_screen/call_screen/widget/viedo_list/viedo_list.dart';

class ViedoCall extends StatelessWidget {
  const ViedoCall({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Start an viedo call'),
